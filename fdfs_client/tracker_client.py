...
from fdfs_client.connection import tcp_send_data, tcp_recv_response
...
from fdfs_client.utils import appromix
...
class Storage_info(object):
    def __init__(self):
        ...
        self.fmt = "!B %ds %ds %ds %ds %ds 52QB" % (
            FDFS_STORAGE_ID_MAX_SIZE,
            IP_ADDRESS_SIZE,
            FDFS_DOMAIN_NAME_MAX_LEN,
            IP_ADDRESS_SIZE,
...
class Tracker_client(object):
    ...
    def __init__(self, pool):
        """
        @param pool:
        @type pool: fdfs_client.client.ConnectionPool
        """
        self.pool = pool
    ...
    def tracker_list_servers(self, group_name, storage_ip=None):
        ...
        while num_storage:
            ...
            num_storage -= 1
            i += 1
        return {"Group name": group_name, "Servers": si_list}
